...
#define E SEG_A|SEG_F|SEG_G|SEG_E|SEG_D |NO_DP
#define r SEG_A|SEG_F|SEG_E | NO_DP
#define oup SEG_A|SEG_F|SEG_G|SEG_B | NO_DP
#define odown SEG_G|SEG_C|SEG_D|SEG_E | NO_DP
//load
#define linetop SEG_A | NO_DP
#define linerightt SEG_B | NO_DP
#define linerightb SEG_C |NO_DP
#define linebottom SEG_D |NO_DP
#define lineleftb SEG_E |NO_DP
#define lineleftt SEG_F |NO_DP
...
/* Params: (value, line, decimalindex) */
...
/* Params: (value, Address, Incement amount) */
