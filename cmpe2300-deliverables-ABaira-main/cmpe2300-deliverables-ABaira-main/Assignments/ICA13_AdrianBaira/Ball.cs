...
namespace ICA_08AdrianB
{
    ...
    {
        #region Properties
        public static Random _rng = new Random();          //random number
        public PointF _center;                             //center of the ball
        public Vector2 _velocity;                          //velocity of the ball
        public int _rad;                                   //radius of the ball
        ...
        public void Move(CDrawer canvas)
        {
            ...
            if (_center.X > canvas.m_ciWidth - _rad - 1)
            {
            ...
            if (_center.Y > canvas.m_ciHeight - _rad - 1)
            {
