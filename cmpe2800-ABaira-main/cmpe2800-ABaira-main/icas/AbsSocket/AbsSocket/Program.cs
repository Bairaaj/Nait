...
namespace AbsSocket
{
    ...
    public class AbsSocket
    {
        ...
        Action<List<string>> _dataReady = null;             // callback for data ready
        ...
        public AbsSocket(Socket socket, Action<List<string>> dataReady, Action<Exception> error)
        {
            _socket = socket;
